(function ( $, x5engine ) {
	...
	s.siteId = '29D8ADC77E6955B6C15D3769AD72EF9B';
	s.islocal = true;
	s.version = '17-0-11-0';
	b.push(function () {
		x.setupDateTime();
	...
	b.push(function () {
		x5engine.captcha.instance = new x5engine.captcha.x5captcha({
			"offlineCodes": {
				"0": { letter: 'S', path: 'captcha/imcpa_phw.gif'},
				"1": { letter: 'M', path: 'captcha/imcpa_hpp.gif'},
				"2": { letter: 'R', path: 'captcha/imcpa_45l.gif'},
				"3": { letter: 'E', path: 'captcha/imcpa_gz2.gif'},
				"4": { letter: '5', path: 'captcha/imcpa_cj3.gif'},
				"5": { letter: 'M', path: 'captcha/imcpa_le8.gif'},
				"6": { letter: 'K', path: 'captcha/imcpa_yyy.gif'},
				"7": { letter: 'D', path: 'captcha/imcpa_rag.gif'},
				"8": { letter: 'J', path: 'captcha/imcpa_gfe.gif'},
				"9": { letter: 'N', path: 'captcha/imcpa_kj6.gif'}
			}
		});
	}, false, 'first');
